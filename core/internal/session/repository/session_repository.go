...
func (repo *sessionRepository) FindOneByToken(ctx context.Context, token string) (*domain.Session, error) {
	query := `
...
func (repo *sessionRepository) Create(ctx context.Context, session *domain.Session) (*domain.Session, error) {

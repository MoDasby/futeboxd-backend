...
func (m *MockRepository) Create(ctx context.Context, sessionInput *session.Session) (*session.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, sessionInput)
...
func (m *MockRepository) FindOneByToken(ctx context.Context, token string) (*session.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOneByToken", ctx, token)
	ret0, _ := ret[0].(*session.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) FindOneByToken(ctx, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindOneByToken", reflect.TypeOf((*MockRepository)(nil).FindOneByToken), ctx, token)
}

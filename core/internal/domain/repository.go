...
type ReviewRepository interface {
	...
	ListAll(requesterID, where string, params []any, page *pagination.Page) ([]Review, error)
	ListTrendingMatches(page *pagination.Page) ([]int64, error)
	Search(requesterID, term string, page *pagination.Page) ([]Review, error)
...
type ProfileRepository interface {
	...
	Search(requesterID, term string, page *pagination.Page) ([]Profile, error)
}

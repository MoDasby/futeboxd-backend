...
func (uc *reviewUsecases) getMatchesByReview(footballClient football.Client, reviews []domain.Review) (map[int64]football.Match, error) {
...
func (uc *reviewUsecases) buildWhereClause(options ListReviewsOptions) (string, []any) {

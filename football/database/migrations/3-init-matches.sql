...
BEGIN 
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_enum WHERE enumlabel = 'STATUS_ABANDONED' AND enumtypid = 'status_name_enum'::regtype) THEN
        ALTER TYPE status_name_enum ADD VALUE 'STATUS_ABANDONED';
    END IF;
END $$;
